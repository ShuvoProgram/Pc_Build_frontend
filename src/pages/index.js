        ...
        <HomePageLayout>
          ...
          <div className="my-10">
            <div className="flex text-gray-700 p-2 justify-center text-center">
              <h1 className="w-full md:w-1/4 text-2xl font-bold border-b-2 border-primary pb-3">
                Featured Products
              </h1>
            </div>
            <div className="flex justify-center items-center mx-10">
              <Row
                justify="center"
                className="grid lg:grid-cols-5 md:grid-cols-3 grid-cols-1 gap-5 items-center mt-8"
                gutter={10}
              >
                {products.map((data, id) => (
                  <ProductCard product={data} key={id + 10} />
                ))}
              </Row>
            </div>
